...
module.exports = (io) => {
  ...
  router.post("/sendMessage", async (req, res) => {
    try {
      ...
      // Kiểm tra trạng thái đăng nhập của receiver
      ...
      const updateParams = {
        ...
        UpdateExpression:
          "set lastMessage = :lastMessage, lastMessageAt = :lastMessageAt, isUnread = :isUnread", // Thêm isUnread vào UpdateExpression
